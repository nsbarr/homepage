...
var ShowController = Class.create({
  initialize: function() {
    ...
    Event.observe(
      this.displayManager.previousButton,
      "click",
      this.goBackToPreviousSlide.bind(this, "tapPreviousButton")
    );
    Event.observe(
      this.displayManager.nextButton,
      "click",
      this.advanceToNextBuild.bind(this, "tapNextButton")
    );
  },
  startShow: function() {
  ...
  handleTapEvent: function(a) {
    var b = { pointX: a.memo.pointX, pointY: a.memo.pointY };
  ...
  handleSceneDidLoad: function(a) {
    ...
    this.displayManager.setNextButtonEnabled(
      this.currentSceneIndex < this.script.pageCount - 1
    );
    switch (this.state) {
      case kShowControllerState_WaitingToJump:
  ...
  updateSlideNumber: function() {
    ...
    if (this.currentSlideIndex != a) {
      ...
      this.displayManager.updateSlideNumber(
        this.currentSlideIndex + 1,
        this.script.slideCount
      );
  ...
  createHyperlinks: function(l) {
    ...
    for (j = 0; j < p; j++) {
      ...
      var r = { targetRectangle: u, events: f.events, url: f.url };
      var t = u.x;
      var i = u.y;
      var w = d - (u.x + u.width);
      var o = k - (u.y + u.top);
